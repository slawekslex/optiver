...
params_parallel = {
 ...
 'do_subtract': False,
 'do_tau': False,
 'emb_p': 0.026252733877647205,
 'emb_size': 13,
 'jit_std': 0.021356654858340495,
 'lr': 0.007465445725704355,
 'mask_perc': 15,
 'multiplier0': 0.3626055471264401,
 'multiplier1': 0.19073029412891845,
 'multiplier2': 0.01053311384196202,
 'p0': 0.7074911272537261,
 'p1': 0.1154956043428409,
 'p2': 0.28889432723990216,
 'time_p0': 0.06230957213512787,
 'time_p1': 0.21270253130639152,
 'time_p2': 0.2372102028402129,
 'wd': 0.015417578723940367
}
...
def parallel_predictions():
    ...
    ps = [0, params['p1'], params['p2']]
    bottleneck = params['bottleneck']
    time_ps = [params[f'time_p{i}'] for i in range(3)]
    multipliers = [params[f'multiplier{i}'] for i in range(3)]
    emb_p = params['emb_p']
    ...
    learn.load('parallelv2_0')
    preds, ys = learn.get_preds(dl = dls.valid, reorder=False)
    print('should be .2145', rmspe_masked(preds, ys))
